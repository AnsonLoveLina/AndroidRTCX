...
import com.hisign.rtcx.RoomParametersFetcher.RoomParametersFetcherEvents;
import com.hisign.rtcx.WebSocketChannelClient.WebSocketChannelEvents;
...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelEvents {
  ...
  private void signalingParametersReady(final SignalingParameters signalingParameters) {
    ...
    Log.d(TAG, "Stuff URL: " + messageUrl);
